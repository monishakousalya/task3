...
>>>>>>> c8583d8aafc6b6285b28e30218bf035acfb0705b
                    ...
                    <div className="cd-timeline-content">
<<<<<<< HEAD
                        <h2 className='heading'> React task 5  </h2>
                        <p>
                            There are  stages in this task.<br />
                            1. Create a UI for a Hostel.<br />
                            2. It should contain a Login page with username and password .It should also have a register page to register a room.<br />
                            3. The details should be stored in database<br/>

                            Refer : <br />
                            1. <a href='https://medium.com/@prmeister89/getting-started-with-react-8d67e2adc4df'>Getting started with react</a><br />
                            2. <a href='https://hackernoon.com/getting-started-with-react-redux-1baae4dcb99b'>Getting started with react and redux</a><br />
                            <b>** The upload button would show up at 4pm on October 10th. All the best **</b><br />
                        </p>
                        {/*{this.state.task.indexOf(1) > -1 ?   <Alert color="success">*/}
                        {/*Submitted !! :) will get back soon*/}
                        {/*</Alert> : ''}*/}
